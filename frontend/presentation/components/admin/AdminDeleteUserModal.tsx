                    ...
                    <>
                        ...
                        <div className="text-center mb-4">
                            <p className="text-gray-400 text-sm">
                                You are about to delete <span className="text-white font-medium">{user.firstName} {user.lastName}</span>
                            </p>
                        </div>

                        <div className="space-y-3 mb-6 p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                            <p className="text-sm text-gray-300">
                                This action is <span className="text-red-400 font-semibold">permanent and irreversible</span>. Deleting this user will remove:
                            </p>
