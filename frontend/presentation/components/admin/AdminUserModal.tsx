...
import { X, Mail, User, Lock, Shield, Loader2, Eye, EyeOff, UserPlus } from 'lucide-react'
...
export function AdminUserModal({ isOpen, onClose, onSuccess }: AdminUserModalProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-slate-900/95 p-6 text-left shadow-2xl transition-all border border-white/10 backdrop-blur-xl">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        <h3 className="text-xl font-bold text-white tracking-tight">Create User</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400 ml-1">Role</label>
                        <div className="relative group">
