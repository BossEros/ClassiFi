                ...
                <table className="w-full">
                    <thead>
                        <tr className="border-b border-white/10">
                            ...
                            >
                                Student Name <SortIndicator column="name" currentSort={sortKey} sortOrder={sortOrder} />
                            </th>
                            <th
                            ...
                            >
                                Originality <SortIndicator column="originality" currentSort={sortKey} sortOrder={sortOrder} />
                            </th>
                            <th
                                onClick={() => handleSort("similarity")}
                                className="px-6 py-4 text-center text-sm font-semibold text-slate-300 cursor-pointer hover:text-white transition-colors select-none"
                            >
                                Highest Similarity <SortIndicator column="similarity" currentSort={sortKey} sortOrder={sortOrder} />
                            </th>
                            ...
                            paginatedStudents.map((student) => {
                                ...
                                return (
                                    <tr
                                        ...
                                        className={`border-b border-white/5 transition-all duration-200 cursor-pointer ${isSelected
                                            ? "bg-teal-500/10"
                                            : "hover:bg-white/5"
                                            }`}
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            <span
                                                className={`inline-flex items-center justify-center w-8 h-8 rounded-full text-xs font-semibold ${student.suspiciousPairs > 0
