    ...
    >
      <CardContent className="p-5 h-full flex flex-col relative z-10">
        ...
        <div className="flex items-start justify-between mb-3">
          <span className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-teal-500/10 text-teal-300 border border-teal-500/20 font-mono">
            {classItem.classCode}
          </span>
          {isArchived && (
            <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-slate-500/20 text-slate-400 border border-slate-500/20">
              Archived
            </span>
          )}
        </div>
        ...
        {/* Title */}
        <h3 className="text-xl font-bold text-white tracking-tight mb-1 group-hover:text-teal-200 transition-colors line-clamp-2">
          {classItem.className}
        </h3>

        {/* Term Info */}
        {/* Term Info & Year Level */}
        <div className="flex flex-wrap gap-y-1 text-sm text-slate-400 mb-4 items-center">
          {classItem.yearLevel && (
            <>
        ...
        <div className="mt-auto pt-4 border-t border-white/5 flex items-center justify-between">
          ...
          <GraduationCap className="w-5 h-5 text-slate-500 group-hover:text-teal-400 transition-all transform group-hover:scale-110" />
        </div>
      </CardContent>
