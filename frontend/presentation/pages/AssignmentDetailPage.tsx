                              ...
                              <div className="relative rounded-lg border border-white/5 overflow-hidden bg-black/20 group select-none">
                                ...
                                <div className="absolute inset-0 flex flex-col pointer-events-none opacity-40 blur-[2px]">
                                  ...
                                  <div className="flex items-center justify-between p-3 border-b border-white/5">
                                    <div className="flex items-center gap-3">
                                      <div className="w-6 h-6 rounded-md bg-purple-500/10 border border-purple-500/20"></div>
                              ...
                              .map(({ originalIndex, ...testCase }) => {
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    >
                                      <div className="flex items-center gap-3">
                                        <span className="w-6 h-6 rounded-md flex items-center justify-center text-xs font-mono border bg-purple-500/10 text-purple-400 border-purple-500/20">
                                          {originalIndex + 1}
                                        </span>
                                        <div className="flex items-center gap-2">
                                          <span className="text-sm font-medium text-gray-200">
