    ...
    const validateForm = (): boolean => {
        ...
        if (!formData.academicYear) {
            ...
            if (endYear !== startYear + 1) {
                newErrors.academicYear = 'End year must be exactly 1 year after start year'
            }
        }
                            ...
                            <CardHeader>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <CardDescription className="mt-1">Enter the core details for your class</CardDescription>
                                    </div>
                                </div>
                            </CardHeader>
                            ...
                            <CardHeader>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <CardDescription className="mt-1">Set when this class meets</CardDescription>
                                    </div>
                                </div>
                            </CardHeader>
                            <CardContent className="space-y-5">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {DAYS.map(day => (
                                            <button
                                                ...
                                                disabled={isLoading}
                                                title={day.label}
                                                className={`px-3 py-2 rounded-lg text-sm font-medium transition-all ${formData.schedule.days.includes(day.value)
                            ...
                            <CardHeader>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <CardDescription className="mt-1">When this class runs</CardDescription>
                                    </div>
                                </div>
                            </CardHeader>
                            <CardContent className="space-y-5">
                                {/* Year Level */}
                                <div className="space-y-2">
                                    <label htmlFor="yearLevel" className="text-sm font-medium text-white">
                                        Year Level <span className="text-red-400">*</span>
                                    </label>
                                    <select
                                        id="yearLevel"
                                        value={formData.yearLevel}
                                        onChange={e => handleInputChange('yearLevel', parseInt(e.target.value) as 1 | 2 | 3 | 4)}
                                        disabled={isLoading}
                                ...
                                {/* Semester */}
                                <div className="space-y-2">
                                    <label htmlFor="semester" className="text-sm font-medium text-white">
                                    ...
                                    <select
                                        ...
                                        className="w-full px-4 py-2.5 rounded-lg bg-white/5 border border-white/10 text-white text-sm focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50"
                                    >
                                        <option value={1} className="bg-slate-800 text-white">1st Semester</option>
                                        <option value={2} className="bg-slate-800 text-white">2nd Semester</option>
                                    </select>
                                </div>

                                {/* Academic Year */}
                                <div className="space-y-2">
                                    <label htmlFor="academicYear" className="text-sm font-medium text-white">
                                    ...
                                    />
                                    {errors.academicYear && (
                                        <p className="text-xs text-red-400">{errors.academicYear}</p>
                                    )}
