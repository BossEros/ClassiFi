...
describe('Auth Validation', () => {
    ...
    describe('validatePassword', () => {
        ...
        it('should return error for missing uppercase', () => {
            expect(validatePassword('lowercaseonly1!')).toBe('Password must contain at least one uppercase letter');
        });

        it('should return error for missing lowercase', () => {
            expect(validatePassword('UPPERCASEONLY1!')).toBe('Password must contain at least one lowercase letter');
        });
        ...
        it('should return error for missing special char', () => {
            expect(validatePassword('NoSpecialChar1')).toBe('Password must contain at least one special character (!@#$%^&*(),.?":{}|<>)');
        });
    ...
    describe('validatePasswordsMatch', () => {
        it('should return error for empty confirm password', () => {
            expect(validatePasswordsMatch('password', '')).toBe('Please confirm your password');
        });

        it('should return error for mismatching passwords', () => {
            expect(validatePasswordsMatch('password', 'different')).toBe('Passwords do not match');
        });
    ...
    describe('validateFirstName', () => {
        ...
        it('should return error for short first name', () => {
            expect(validateFirstName('a')).toBe('First name must be at least 2 characters long');
        });
    ...
    describe('validateLastName', () => {
        ...
        it('should return error for short last name', () => {
            expect(validateLastName('a')).toBe('Last name must be at least 2 characters long');
        });
