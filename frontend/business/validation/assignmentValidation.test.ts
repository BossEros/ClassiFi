...
describe('assignmentValidation', () => {
    ...
    describe('validateAssignmentTitle', () => {
        ...
        it('should return error for title exceeding 150 characters', () => {
            ...
            expect(validateAssignmentTitle(title)).toBe('Assignment title must not exceed 150 characters')
        })
    })
    ...
    describe('validateDescription', () => {
        it('should return null for valid description', () => {
            expect(validateDescription('This is a detailed assignment description that is long enough.')).toBeNull()
        })
    ...
    describe('validateProgrammingLanguage', () => {
        ...
        it('should return error for empty language', () => {
            expect(validateProgrammingLanguage('')).toBe('Programming language is required')
        })

        it('should return error for invalid language', () => {
            expect(validateProgrammingLanguage('rust')).toBe('Invalid programming language. Must be Python, Java, or C')
        })
    })
    ...
    describe('validateCreateAssignmentData', () => {
        ...
        it('should return valid result for complete correct data', () => {
            const result = validateCreateAssignmentData({
                ...
                description: 'This assignment covers variables and data types in Python.',
        ...
        it('should return error for missing assignmentName', () => {
            ...
            expect(result.errors.assignmentName).toBe('Assignment title is required')
        })
        ...
        it('should return error for missing programmingLanguage', () => {
            ...
            expect(result.isValid).toBe(false)
            expect(result.errors.programmingLanguage).toBe('Programming language is required')
        })
        ...
        it('should return multiple errors for multiple invalid fields', () => {
            ...
            expect(result.isValid).toBe(false)
            expect(result.errors.assignmentName).toBeDefined()
            expect(result.errors.description).toBeDefined()
            expect(result.errors.programmingLanguage).toBeDefined()
