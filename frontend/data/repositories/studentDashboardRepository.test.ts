...
describe("studentDashboardRepository", () => {
  ...
  describe("getCompleteDashboardDataForStudentId", () => {
    ...
    it("passes custom limits to API", async () => {
      ...
      await studentDashboardRepository.getCompleteDashboardDataForStudentId(
        1,
        20,
        15,
      )
  ...
  describe("getAllEnrolledClassesForStudentId", () => {
    ...
    it("fetches enrolled classes for a student", async () => {
      ...
      const result =
        await studentDashboardRepository.getAllEnrolledClassesForStudentId(1)

      expect(apiClient.get).toHaveBeenCalledWith("/student/dashboard/1/classes")
  ...
  describe("getAllPendingAssignmentsForStudentId", () => {
    ...
    it("fetches pending assignments with default limit", async () => {
      ...
      const result =
        await studentDashboardRepository.getAllPendingAssignmentsForStudentId(1)
    ...
    it("passes custom limit to API", async () => {
      ...
      await studentDashboardRepository.getAllPendingAssignmentsForStudentId(
        1,
        20,
      )
  ...
  describe("enrollStudentInClassWithCode", () => {
    ...
    it("joins a class with valid code", async () => {
      ...
      const result =
        await studentDashboardRepository.enrollStudentInClassWithCode(
          1,
          "CS101",
        )
  ...
  describe("unenrollStudentFromClassById", () => {
    ...
    it("leaves a class successfully", async () => {
      ...
      const result =
        await studentDashboardRepository.unenrollStudentFromClassById(1, 1)
    ...
    it("throws error on server failure", async () => {
      ...
      await expect(
        studentDashboardRepository.unenrollStudentFromClassById(1, 1),
    ...
    it("throws default error when no data returned", async () => {
      ...
      await expect(
        studentDashboardRepository.unenrollStudentFromClassById(1, 1),
      ).rejects.toThrow("Failed to leave class")
    })
  })
})
