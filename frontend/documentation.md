...
- Teacher gradebook rows are ordered by active-student class standing first, using the same rounded percentage average shown in the `Average` column; alphabetical order is now only a tie-breaker.
