...
export function ProfileDropdown({
  ...
  const dropdownMenu = (
    <div
      ref={dropdownMenuRef}
      className={cn(
        "z-[11000] rounded-lg border border-slate-200 bg-white p-1 shadow-lg shadow-black/25",
    ...
    >
      <button
        ...
        className={cn(
          "w-full flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-100 transition-colors rounded-md",
      ...
      <button
        ...
        className={cn(
          "w-full flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-rose-500 hover:bg-rose-50 transition-colors rounded-md",
