  ...
  ({ className, type, hasError, ...props }, ref) => {
    return (
      <input
        ...
        className={cn(
          "block h-12 w-full rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm px-4 py-3 text-sm text-white placeholder:text-slate-400 transition-all duration-200",
