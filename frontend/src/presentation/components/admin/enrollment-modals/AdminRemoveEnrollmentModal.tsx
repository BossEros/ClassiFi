  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
      ...
      <div
        ...
        className="relative z-10 w-full max-w-160 overflow-hidden rounded-3xl border border-rose-200 bg-white shadow-xl animate-in fade-in-0 zoom-in-95 duration-200"
