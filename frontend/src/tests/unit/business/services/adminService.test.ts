...
describe("adminService", () => {
  ...
  describe("updateUserRole", () => {
    it("updates role successfully", async () => {
      ...
      expect(adminRepository.updateUserRoleById).toHaveBeenCalledWith(
        1,
        "teacher",
      )
  ...
  describe("toggleUserStatus", () => {
    it("toggles status successfully", async () => {
      ...
      expect(adminRepository.toggleUserAccountStatusById).toHaveBeenCalledWith(
        1,
      )
      expect(result).toEqual(updatedUser)
    })
  ...
  describe("getClassStudents", () => {
    it("fetches and transforms students", async () => {
      ...
      vi.mocked(
        adminRepository.getEnrolledStudentsInClassById,
      ).mockResolvedValue({
        success: true,
