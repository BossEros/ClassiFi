...
import * as teacherDashboardRepository from "@/data/repositories/teacherDashboardRepository"
...
describe("teacherDashboardRepository", () => {
  ...
  describe("getCompleteDashboardDataForTeacherId", () => {
    ...
    it("fetches complete dashboard data", async () => {
      ...
      const result =
        await teacherDashboardRepository.getCompleteDashboardDataForTeacherId(1)
    ...
    it("passes custom limits to API", async () => {
      ...
      await teacherDashboardRepository.getCompleteDashboardDataForTeacherId(
        1,
        20,
        15,
      )
  ...
  describe("getRecentClassesForTeacherId", () => {
    ...
    it("fetches recent classes with default limit", async () => {
      ...
      const result =
        await teacherDashboardRepository.getRecentClassesForTeacherId(1)
