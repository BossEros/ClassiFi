...
const hashFilter_js_1 = require("./hashFilter.js");
const rollingHash_js_1 = require("./rollingHash.js");
/**
 ...
 */
class WinnowFilter extends hashFilter_js_1.HashFilter {
    k;
    windowSize;
    /**
     ...
     */
    fingerprints(tokens) {
        const hash = new rollingHash_js_1.RollingHash(this.k);
        let window = [];
