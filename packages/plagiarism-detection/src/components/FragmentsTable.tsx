                    ...
                    {fragments.map((fragment, index) => {
                        ...
                        return (
                            <tr
                                ...
                                style={{
                                    cursor: 'pointer',
                                    backgroundColor: isSelected ? 'rgba(26, 188, 156, 0.15)' : 'transparent',
                                    borderBottom: '1px solid #e0e0e0',
                                    transition: 'background-color 0.15s',
                                }}
                                onMouseEnter={(e) => {
                                    if (!isSelected) {
                                        e.currentTarget.style.backgroundColor = 'rgba(60, 115, 168, 0.1)';
                                    }
                                }}
                                onMouseLeave={(e) => {
                                    if (!isSelected) {
                            ...
                            >
                                ...
                                <td style={{ padding: '10px' }}>{formatRegion(fragment.leftSelection)}</td>
                                <td style={{ padding: '10px' }}>{formatRegion(fragment.rightSelection)}</td>
