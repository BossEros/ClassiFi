...
import { UserNotFoundError, ClassNotFoundError, InvalidRoleError } from '../../shared/errors.js';
import type { ClassFilterOptions, PaginatedResult, CreateClassData, UpdateClassData } from './admin.types.js';
...
export class AdminClassService {
     ...
     */
    async getClassAssignments(classId: number): Promise<Array<{
        id: number;
        title: string;
