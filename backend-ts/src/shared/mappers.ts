...
import type { Pair, Fragment, File as PlagiarismFile } from '../lib/plagiarism/index.js';
...
export function toPlagiarismPairDTO(pair: Pair, resultId?: number): PlagiarismPairDTO {
    return {
        id: resultId ?? pair.id,
        leftFile: {
            id: pair.leftFile.id,
...
export function toPlagiarismFragmentDTO(fragment: Fragment, index: number): PlagiarismFragmentDTO {
    return {
        id: index,
        leftSelection: {
