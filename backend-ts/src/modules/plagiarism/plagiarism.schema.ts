...
export const ResultDetailsResponseSchema = z.object({
  ...
  result: z.object({
    id: z.number(),
    submission1Id: z.number(),
    submission2Id: z.number(),
    structuralScore: z.string(),
    semanticScore: z.string(),
    hybridScore: z.string(),
    overlap: z.number(),
    longestFragment: z.number(),
    leftCovered: z.number(),
    rightCovered: z.number(),
    leftTotal: z.number(),
    rightTotal: z.number(),
  }),
  fragments: z.array(FragmentResponseSchema),
