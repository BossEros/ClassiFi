 ...
 */
@injectable()
export class SubmissionRepository extends BaseRepository<typeof submissions, Submission, NewSubmission> {
    constructor() {
        super(submissions);
    }

    /** Get a submission by ID */
    async getSubmissionById(submissionId: number): Promise<Submission | undefined> {
    ...
    async getSubmissionCount(assignmentId: number, studentId: number): Promise<number> {
