...
describe("Notification Controller", () => {
    ...
    describe("GET /", () => {
        it("should return paginated notifications", async () => {
            ...
            vi.mocked(mockNotificationService.getUserNotifications).mockResolvedValue(mockResult);
            ...
            expect(mockNotificationService.getUserNotifications).toHaveBeenCalledWith(1, 1, 20, undefined);
        ...
        it("should support unreadOnly filter", async () => {
            ...
            expect(mockNotificationService.getUserNotifications).toHaveBeenCalledWith(1, 1, 20, true);
        });
    ...
    describe("PATCH /read-all", () => {
        it("should mark all notifications as read", async () => {
            vi.mocked(mockNotificationService.markAllAsRead).mockResolvedValue(undefined);
    ...
    describe("DELETE /:id", () => {
        it("should delete notification", async () => {
            vi.mocked(mockNotificationService.deleteNotification).mockResolvedValue(undefined);
