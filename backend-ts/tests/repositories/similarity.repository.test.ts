...
describe('SimilarityRepository', () => {
    ...
    describe('createReport Logic', () => {
        it('should create a new similarity report', async () => {
            ...
            const { SimilarityRepository } = await import('../../src/repositories/similarity.repository.js');
    ...
    describe('createResults Logic', () => {
        it('should batch insert results', async () => {
            ...
            const result = await similarityRepo.createResults([
                { reportId: 1, submission1Id: 1, submission2Id: 2, structuralScore: '0.5' } as any,
                { reportId: 1, submission1Id: 1, submission2Id: 3, structuralScore: '0.7' } as any,
            ]);
