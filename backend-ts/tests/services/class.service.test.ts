...
describe('ClassService', () => {
    ...
    describe('createClass', () => {
        ...
        it('should throw InvalidRoleError if user is not found', async () => {
            ...
            await expect(classService.createClass(
                999, 'Test Class', 'ABCDEFGH', 1, 1, '2024-2025', { days: ['monday'], startTime: '10:00', endTime: '11:00' }
        ...
        it('should throw InvalidRoleError if user is not a teacher', async () => {
            ...
            await expect(classService.createClass(
                student.id, 'Test', 'ABCDEFGH', 1, 1, '2024', { days: ['monday'], startTime: '10:00', endTime: '11:00' }
            )).rejects.toThrow(InvalidRoleError);
        });
    ...
    describe('generateClassCode', () => {
        it('should generate a unique code and retry on collision', async () => {
            mockClassRepo.checkClassCodeExists!
    ...
    describe('getClassById', () => {
        ...
        it('should throw NotClassOwnerError if teacher mismatch', async () => {
            ...
            await expect(classService.getClassById(1, 999)).rejects.toThrow(NotClassOwnerError);
        });

        it('should throw ClassNotFoundError if class does not exist', async () => {
            mockClassRepo.getClassById!.mockResolvedValue(undefined);

            await expect(classService.getClassById(999)).rejects.toThrow(ClassNotFoundError);
        });
    });
    ...
    describe('getClassesByTeacher', () => {
        it('should return classes with student counts using optimized method', async () => {
            ...
            mockClassRepo.getClassesWithStudentCounts!.mockResolvedValue(classesWithCounts);
            ...
            expect(mockClassRepo.getClassesWithStudentCounts).toHaveBeenCalledWith(1, true);
        });
    });
    ...
    describe('updateClass', () => {
        it('should update class successfully', async () => {
            ...
            const result = await classService.updateClass(1, 1, { className: 'Updated' });
        ...
        it('should throw ClassNotFoundError if class missing', async () => {
            ...
            await expect(classService.updateClass(1, 1, {})).rejects.toThrow(ClassNotFoundError);
        });
        ...
        it('should throw NotClassOwnerError if not owner', async () => {
            ...
            await expect(classService.updateClass(1, 999, {})).rejects.toThrow(NotClassOwnerError);
        });
    });
    ...
    describe('deleteClass', () => {
        ...
        it('should throw ClassNotFoundError if class missing', async () => {
            ...
            await expect(classService.deleteClass(1, 1)).rejects.toThrow(ClassNotFoundError);
        });
        ...
        it('should throw NotClassOwnerError if not owner', async () => {
            ...
            await expect(classService.deleteClass(1, 999)).rejects.toThrow(NotClassOwnerError);
        });
    });
});
