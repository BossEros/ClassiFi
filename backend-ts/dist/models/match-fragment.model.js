 ...
 */
export const matchFragments = pgTable('match_fragments', {
    id: serial('id').primaryKey(),
    similarityResultId: integer('similarity_result_id').notNull().references(() => similarityResults.id, { onDelete: 'cascade' }),
    // Left file position
    ...
    index('idx_match_fragments_result').on(table.similarityResultId),
]);
...
//# sourceMappingURL=match-fragment.model.js.map